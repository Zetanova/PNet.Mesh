...
| 048 | 2026-07-01 | wireguard/tests | Add PNet-to-PNet WireGuard-compatible transport e2e coverage for internal protobuf frames. | high | ready | [048-pnet-to-pnet-wireguard-compatible-transport-e2e](issues/048-pnet-to-pnet-wireguard-compatible-transport-e2e.md) |
