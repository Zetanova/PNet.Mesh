...
| 063 | 2026-07-02 | benchmark/integration-phase-4 | Add comparison result schema for latency, bandwidth, CPU, RSS, GC, and allocations. | medium | ready | [063-tun-comparison-result-schema-and-allocation-counters](issues/063-tun-comparison-result-schema-and-allocation-counters.md) |
