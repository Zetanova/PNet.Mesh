...
|------|------|--------|--------|----------|
| 2026-07-01 | `gate-depends: [036, 037, 038, 039, 040, 041, 042]` | source | blocked | #036, #037, #038, and #039 are completed, but #040, #041, and #042 remain open, so the issue stays gated. |
