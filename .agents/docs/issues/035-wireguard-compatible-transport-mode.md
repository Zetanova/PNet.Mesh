...
|------|------|--------|--------|----------|
| 2026-07-01 | `gate-depends: [036, 037, 038, 039, 040, 041, 042, 045, 046, 047, 048]` | source | blocked | #036, #037, #038, #039, #040, and #041 are completed, but #042, #045, #046, #047, and #048 remain open, so the parent stays gated. |
